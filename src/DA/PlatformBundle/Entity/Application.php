 ...
 * @ORM\Entity(repositoryClass="DA\PlatformBundle\Repository\ApplicationRepository")
...
class Application
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="DA\PlatformBundle\Entity\Advert", inversedBy="applications")
